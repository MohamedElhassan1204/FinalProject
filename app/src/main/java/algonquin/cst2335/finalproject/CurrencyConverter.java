...
public class CurrencyConverter extends AppCompatActivity {
     ...
     */
    private final String duplicateFav = "Favourite already exists";
    /**
     * Alert message for favourite created.
     */
    private final String favCreated = "Favourite created";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BigDecimal roundedRate = BigDecimal.valueOf(prefs.getFloat("amount", 0));
    ...
    private class CurrencyQuery extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String jsonUrl = null;
            try {
                jsonUrl = "https://api.getgeoapi.com/v2/currency/convert?format=json&from=" + URLEncoder.encode(baseCurrency, "UTF-8") + "&to=" +
                        URLEncoder.encode(targetCurrency, "UTF-8") + "&amount=1&api_key=f841d08397027b23391b77d5d1ba97033f4324f3&format=json";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.currencyToHome) {
